...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2023 at 09:33 PM
...
CREATE TABLE `applicant` (
  ...
  `spouseID` varchar(50) NOT NULL,
  `spouseName` varchar(50) NOT NULL,
  `spouseDOB` date NOT NULL,
  `spouseRace` varchar(50) NOT NULL,
  `spouseCitizenship` varchar(50) NOT NULL,
  `spouseEducation` varchar(50) NOT NULL,
  `spouseJob` varchar(50) NOT NULL,
  `spouseAddrs` varchar(50) NOT NULL,
  `spousePhnNum` varchar(50) NOT NULL,
  `spouseMaritalStatus` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `applicant` (`applicantID`, `applicantName`, `applicantDOB`, `applicantRace`, `applicantCitizenship`, `applicantEducation`, `applicantJob`, `applicantAddrs`, `applicantPhnNum`, `applicantMaritalStatus`, `spouseID`, `spouseName`, `spouseDOB`, `spouseRace`, `spouseCitizenship`, `spouseEducation`, `spouseJob`, `spouseAddrs`, `spousePhnNum`, `spouseMaritalStatus`) VALUES
('021125120421', '', '0000-00-00', '', '', '', '', '', '', '', '12345', '', '0000-00-00', '', '', '', '', '', '', '');
...
--
-- Dumping data for table `nikahdetails`
--

INSERT INTO `nikahdetails` (`coupleID`, `nikahDate`, `nikahLocation`, `masKahwin`, `nikahType`, `waliName`, `waliAddrs`, `waliDOB`, `waliAge`, `waliRelation`, `wali_ID`, `witnessName`, `witnessAge`, `witnessAddrs`, `witnessID`, `applicantID`, `spouseID`) VALUES
('3122', '2030-01-01', 'Alamat', 0, '', '', 'Alamat Wali', '0000-00-00', 0, '', '', '', 0, '', '', '021125120421', '12345');
...
ALTER TABLE `applicant`
  ...
  ADD UNIQUE KEY `spouseID` (`spouseID`);
...
ALTER TABLE `nikahdetails`
  ADD PRIMARY KEY (`coupleID`),
  ADD KEY `applicantID` (`applicantID`),
  ADD KEY `spouseID` (`spouseID`) USING BTREE;
...
ALTER TABLE `nikahdetails`
  ...
  ADD CONSTRAINT `nikahdetails_ibfk_2` FOREIGN KEY (`spouseID`) REFERENCES `applicant` (`spouseID`);
