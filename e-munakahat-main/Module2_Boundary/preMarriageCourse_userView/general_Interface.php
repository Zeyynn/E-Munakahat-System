    ...
    <div class="sidebar">
        <div class="sidebarMenu">
            ...
            <table>
                ...
                <td>
                    <ul>
                        <li><a href="../marriageApplication_UserView/viewRegistrationStatus.php">Permohonan Kebenaran</a></li>
                        <li><a href="viewCourseList.php">Kursus Pra-Perkahwinan</a></li>
                    </ul>
                </td>
            </table>

            <table>
                <tr><th><a href="../../Module3/boundary/nikahRegistration_UserView/viewRegistrationStatus.php">Marriage Registration</a></th></tr>
                <td>
                    <ul>
