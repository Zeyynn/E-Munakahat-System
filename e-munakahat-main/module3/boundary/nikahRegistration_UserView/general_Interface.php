...
<html>
<header>
    <link rel="stylesheet" href="stylesheet/generalStyle.css">
    ...
    <div class="sidebar">
        <div class="sidebarMenu">
            ...
            <table>
                ...
                <td>
                    <ul>
                        <li><a href="../../../Module2_Boundary/marriageApplication_UserView/viewRegistrationStatus.php">Permohonan Kebenaran</a></li>
                        <li><a href="../../../Module2_Boundary/preMarriageCourse_userView/viewCourseList.php">Kursus Pra-Perkahwinan</a></li>
                    </ul>
                </td>
            </table>

            <table>
                <tr><th><a href="viewRegistrationStatus.php">Marriage Registration</a></th></tr>
                <td>
                    <ul>
                        <li><a class="marriageReg">Perkahwinan Dengan Kebenaran</a></li>
