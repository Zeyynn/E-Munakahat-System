...
<header>
    ...
    <link rel="stylesheet" href="stylesheet/nikahStyle.css">
...
<body>
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active text-white" onclick="location='nikahInfoForm.php'" id="pills-nikah-tab" data-bs-toggle="pill" data-bs-target="#pills-nikah" type="button" role="tab" aria-controls="nikah" aria-selected="true">Maklumat Nikah</button>
        </li>
        <li class="nav-item" role="presentation">
